...
const items = [
  ...
  { label: 'xs', action: () => wrapSelection('[', ']{.text-xs}'), tooltip: '極小サイズ', style: 'text-xs' },
  { label: 'sm', action: () => wrapSelection('[', ']{.text-sm}'), tooltip: '小サイズ', style: 'text-sm' },
  { label: 'LG', action: () => wrapSelection('[', ']{.text-lg}'), tooltip: '大サイズ', style: 'text-lg' },
  { label: 'XL', action: () => wrapSelection('[', ']{.text-xl}'), tooltip: '特大サイズ', style: 'text-xl' },
  { label: '赤', action: () => wrapSelection('[', ']{color="red"}'), tooltip: '赤', style: 'text-red-600' },
  { label: '青', action: () => wrapSelection('[', ']{color="blue"}'), tooltip: '青', style: 'text-blue-600' },
  { label: '緑', action: () => wrapSelection('[', ']{color="green"}'), tooltip: '緑', style: 'text-green-600' },
